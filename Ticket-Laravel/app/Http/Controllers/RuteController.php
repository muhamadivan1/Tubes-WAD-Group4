...
class RuteController extends Controller
{
     ...
     */
    public function index() //menapilkan data ke table
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request) //menyimpan data ke table rute
    {
        ...
        Rute::updateOrCreate(   //menyimpan data sekaligus mengupdate ke table rute
            [
                'id' => $request->id
            ],
            [
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit($id)   //menampilkan data yg mau diedit
    {
        $rute = Rute::find($id);
        $transportasi = Transportasi::orderBy('kode')->orderBy('name')->get();
