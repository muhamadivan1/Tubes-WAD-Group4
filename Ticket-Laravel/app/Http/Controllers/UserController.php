...
class UserController extends Controller
{
     ...
     */
    public function index() //menampilkan view user berdasarkan level dan name
    {
    ...
    {
        $this->validate($request, [ //mevalidasi data
    ...
    public function password(Request $request)  //mengubah password
    {
        $this->validate($request, [
            'password' => 'required|string|min:8|confirmed'
        ]);
